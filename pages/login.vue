<template>
    <div>
        <div
            class="grid grid-cols-12 w-full px-5 bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')] z-10">
            <div class="col-span-6 ">
                <div class="w-full h-screen flex justify-center items-center z-50">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1"
                        ...
                        <defs>
                            <linearGradient id="ac3cc305-f6db-42f4-bbbd-32121ee27a74-1117" x1="403.57" y1="833.5"
                                x2="403.57" y2="218.16" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                            </linearGradient>
                            <linearGradient id="ad14f186-b27f-416c-b629-0bafa2f1236e-1118" x1="940.67" y1="825.72"
                                x2="940.67" y2="263.72" xlink:href="#ac3cc305-f6db-42f4-bbbd-32121ee27a74-1117" />
                        </defs>
                        <title>medicine</title>
                        <ellipse cx="367.38" cy="766.65" rx="97.44" ry="15.65" fill="#0ea5e9" opacity="0.1" />
                        <ellipse cx="897.05" cy="767.09" rx="121.59" ry="15.65" fill="#0ea5e9" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path d="M162.57,242.81H106.9a422,422,0,0,1,29.61-40.76c8.27-10.16,17-20.06,26.06-29.6Z"
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path
                        ...
                        <rect x="139.57" y="338.19" width="76.3" height="138.33" fill="#0ea5e9" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <rect x="629.96" y="194.56" width="62.92" height="139.35" fill="#0ea5e9" opacity="0.1" />
                        <polygon
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path d="M904.22,242.81h-41V230.07H881.6V192.12q2.39.87,4.76,1.79v36.16h17.86Z"
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path d="M1152.27,535.16h-55.7V419.55h30.14C1142.31,456,1152.22,496,1152.27,535.16Z"
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <rect x="659.18" y="233.3" width="33.71" height="43.69" fill="#0ea5e9" opacity="0.1" />
                        <rect x="659.18" y="323.86" width="33.71" height="10.06" fill="#0ea5e9" opacity="0.1" />
                        <rect x="659.18" y="338.19" width="33.71" height="29.35" fill="#0ea5e9" opacity="0.1" />
                        <rect x="659.18" y="414.42" width="33.71" height="43.69" fill="#0ea5e9" opacity="0.1" />
                        <rect x="659.18" y="504.98" width="33.71" height="43.69" fill="#0ea5e9" opacity="0.1" />
                        <path d="M740.12,687.7c.34,0,.67,0,1,.06l-1,0v10.15h-33.7V654.17h33.7Z"
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path d="M740.12,744.71v33.75q-16.9-1.43-33.7-3.89V744.71Z" transform="translate(-47.24 -58.63)"
                            fill="#0ea5e9" opacity="0.1" />
                        <rect x="380.58" y="473.32" width="144.47" height="3.21" fill="#0ea5e9" opacity="0.1" />
                        <rect x="380.58" y="480.8" width="144.47" height="12.3" fill="#0ea5e9" opacity="0.1" />
                        <rect x="380.58" y="533.42" width="144.47" height="19.78" fill="#0ea5e9" opacity="0.1" />
                        <path d="M572.28,652.15v19.78h-113q-7.36-5.62-14.54-11.54c-3.31-2.73-6.59-5.53-9.93-8.24Z"
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" opacity="0.1" />
                        <path d="M572.28,712.24V732H560.35q-20.11-9.07-39.43-19.79Z" transform="translate(-47.24 -58.63)"
                            fill="#0ea5e9" opacity="0.1" />
                        <rect x="775.83" y="351.6" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="219.09" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="285.15" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="351.21" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="417.26" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="483.32" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="160.05" y="549.38" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="884.4" y="351.6" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="775.83" y="421.75" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="884.4" y="421.75" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="775.83" y="491.89" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="884.4" y="491.89" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="775.83" y="562.04" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="884.4" y="562.04" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="775.83" y="632.19" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <rect x="884.4" y="632.19" width="28.44" height="28.44" fill="#0ea5e9" opacity="0.1" />
                        <polygon points="775.83 720.67 775.83 702.33 804.26 702.33 804.26 718.06 775.83 720.67"
                            fill="#0ea5e9" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-1117)" />
                        <path d="M486.8,513.74l-2.16,9.2s-17.3-8.83-20.42-20.05,5.22-15.48,5.22-15.48l16.12,6.83Z"
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path d="M430.56,678.58a101.24,101.24,0,0,1-11.06,1.26c-.22-5-.35-8.44-.35-8.44l11.12-2.24Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#fff" />
                        <path d="M360.15,778.56s9.66-6.07,16-1.66S360.15,778.56,360.15,778.56Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path d="M435.21,759.79s8.55-1.1,15.73,6.63S435.21,759.79,435.21,759.79Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <g opacity="0.1">
                            <path
                        ...
                        <ellipse cx="132.73" cy="744.94" rx="97.44" ry="15.65" fill="#0ea5e9" opacity="0.1" />
                        ...
                        <polygon points="174.88 592.24 174.32 601.21 91.14 601.21 90.58 592.24 174.88 592.24"
                            fill="#9d9cb5" />
                        <polygon points="174.09 604.95 173.54 613.93 91.93 613.93 91.37 604.95 174.09 604.95"
                            fill="#9d9cb5" />
                        <polygon points="173.3 617.68 172.75 626.65 92.72 626.65 92.16 617.68 173.3 617.68"
                            fill="#9d9cb5" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" />
                        <path d="M47.72,528.76s45.68,25.35,60.33,46.34S180,624.42,180,624.42"
                            transform="translate(-47.24 -58.63)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" />
                        <path d="M108,488.26s24.86,13.8,32.83,25.22S180,540.32,180,540.32"
                            transform="translate(-47.24 -58.63)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#0ea5e9" />
                        <path d="M263.87,506.19s-29.74,25.72-37.3,43.44-45.38,47.43-45.38,47.43"
                            transform="translate(-47.24 -58.63)" fill="none" stroke="#535461" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="url(#ad14f186-b27f-416c-b629-0bafa2f1236e-1118)" />
                        <polygon points="972.51 743.53 971.32 757.7 975.31 756.9 974.71 741.53 972.51 743.53"
                            fill="#1d2366" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#1d2366" />
                        <path d="M927.52,650.23a61.89,61.89,0,0,0,1.18,9c-11.26-1.65-21.71-.83-28.56-.29l0-8.91Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#1d2366" />
                        <path d="M876,439s-14,15-3.4,23.36,17.57.8,17.57.8Z" transform="translate(-47.24 -58.63)"
                            fill="#c7daf5" />
                        <path d="M876,439s-14,15-3.4,23.36,17.57.8,17.57.8Z" transform="translate(-47.24 -58.63)"
                            opacity="0.1" />
                        <path
                        ...
                        <polygon points="777.66 389.76 787.24 397.94 866.1 414.51 856.32 404.53 777.66 389.76"
                            fill="#fff" />
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#fff" />
                        <path d="M919.93,486.72s-23-1-34.14-14.38S911.54,467,911.54,467l9.59,2.2Z"
                            transform="translate(-47.24 -58.63)" fill="#ffb0b1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-47.24 -58.63)" fill="#fff" />
                        <path d="M999.59,459s-15-3-9.78,2,5.19,9.38,11.58,9.18S999.59,459,999.59,459Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path d="M1024.94,566.58s-6.78,4.59,6.19,15.17S1024.94,566.58,1024.94,566.58Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path d="M1012,604.31c0,.6-2.4,22,6.58,27.35S1012,604.31,1012,604.31Z"
                            transform="translate(-47.24 -58.63)" opacity="0.1" />
                        <path
                        ...
                        <path d="M982.82,317.92a29.61,29.61,0,0,1-5.22,16.81,29.66,29.66,0,1,1,5.22-16.81Z"
                            transform="translate(-47.24 -58.63)" fill="#ffb0b1" />
                        <path
                        ...
                        <polygon points="822.6 400.68 827.46 399.14 826.75 403.82 826.6 404.85 825.18 403.37 822.6 400.68"
                            fill="#efc8c4" />
                        <path
                        ...
                        <path d="M861.13,441.7s17.37-.1,13.28,7.29-10.48,8.28-10.48,8.28Z"
                            transform="translate(-47.24 -58.63)" fill="#ffb0b1" />
                        <path
                ...
                <div class="w-full h-screen flex justify-center items-center ">
                    ...
                    <div
                        ...
                        <form class="space-y-6" action="#">
                            <h5 class="text-2xl font-semibold text-sky-500 dark:text-white">Sign in to Apotik</h5>
                            <div>
                            ...
                            <div class="flex items-start">
                                ...
                                <NuxtLink to="/" class="ml-auto text-sm text-sky-600 hover:underline dark:text-sky-500">Lost
                                    Password?</NuxtLink>
                            </div>
                            <button type="submit"
                                class="w-full text-white bg-sky-500 hover:bg-sky-400 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">Login
